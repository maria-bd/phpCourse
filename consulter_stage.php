    ...
    <div class="container">
        <fieldset>
            ...
            <div class="main-domains">
                ...
                <div class="domain selected">Internship</div>
                <div class="domain"><a href="consulter_event.php">Event</a></div>
            </div>
            <br>
            <h3>Select Internship Region & Domain:</h3>
            <br>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (mysqli_num_rows($resultat) > 0) {
                    ...
                    while ($stage = mysqli_fetch_assoc($resultat)) {
                        ?>
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo $stage['name']; ?></h5>
                                <p class="card-text"><strong>Location :</strong> <?php echo $stage['location']; ?></p>
                                <p class="card-text"><strong>Description :</strong> <?php echo $stage['description']; ?></p>
                                <p class="card-text"><strong>Company Name :</strong> <?php echo $stage['company_name']; ?></p>
                                <p class="card-text"><strong>Company Description :</strong> <?php echo $stage['company_description']; ?></p>
                                <p class="card-text"><strong>Duration :</strong> <?php echo $stage['duration']; ?> month(s)</p>
                                <p class="card-text"><strong>Type :</strong> <?php echo $stage['type']; ?></p>
                                <p class="card-text"><strong>Encadreur Name :</strong> <?php echo $stage['encadreur_name']; ?></p>
                                <p class="card-text"><strong>Background :</strong> <?php echo $stage['encadreur_description']; ?></p>
                            </div>
                        </div>
                        <?php
                    }
                } else {
                    echo "There's no internship in this region or domain";
                }
            }
            ?>
        </fieldset>
